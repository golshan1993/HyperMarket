...
public class CustomerAddressModel {
    ...
    public CustomerAddressModel(int customerId, String titleAddress, String firstName,
                                String lastName, String address, String mapAddress,
                                String phoneNumber, String postalCode, String latitude, String longitude, String city, String state) {
